{
  ...
  //Set ATLAS style
  gROOT->LoadMacro("FYS5555/Statistics/utils.h");
  gROOT->SetStyle("ATLAS");
  ATLAS->SetTitleSize(0.06,"Y");
  gROOT->ForceStyle();
  

  ifstream input("FYS5555/Statistics/limitschannelcomb.txt");
  ...
  xsecG->GetHistogram()->SetXTitle("Z' mass [GeV]");
  
  xsecG->GetHistogram()->GetYaxis()->SetRangeUser(5e-3,5e3);
  ...
  leg->AddEntry(xsecG,"#sigma(Z' #rightarrow ee or #mu#mu)","PL");
