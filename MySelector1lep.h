...
class MySelector1lep : public TSelector {
public :
...
h_pTLog;//!
  ...
  // TTreeReaderArray<float> tau_pt_syst = {fReader, "tau_pt_syst"};
   ...
   MySelector1lep(TTree * /*tree*/ =0) { }
   virtual ~MySelector1lep() { }
...
void MySelector1lep::Init(TTree *tree)
{
