...
if arg1 == 'Data': 
        input_dir = 'Escritorio/2lep/Data/'
elif arg1 == 'MC': 
        input_dir = 'Escritorio/2lep/MC/'
...
if arg1 == 'Data': 
        myChain.Process("Escritorio/CodeExample/MySelector.C+", "Data")
else: 
        myChain.Process("Escritorio/CodeExample/MySelector.C+", "MC") 
